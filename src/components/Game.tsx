...
const Game: React.FC<Props> = ({ writeScoreToDB, readScoresFromDB }) => {
  ...
  return (
    <div className="Game">
      ...
      <Map
        targets={targets}
        addToFoundTargets={addToFoundTargets}
        isGameFinished={isGameFinished}
        isGameStarted={isGameStarted}
      />
      {isGameStarted ? (
        ...
        <PopUpScreen
          ...
          rightSide={
            <TargetIntroduction targets={targets} startGame={startGame} />
          }
        />
      )}
      {isGameFinished ? (
        <PopUpScreen
          leftSide={
            <LeaderBoard
              readScoresFromDB={readScoresFromDB}
          ...
          rightSide={
            <SubmitScreen
              isScoreSubmited={isScoreSubmited}
              setIsScoreSubmited={setIsScoreSubmited}
              finalTime={finalTime}
              writeScoreToDB={writeScoreToDB}
            />
          }
        />
      ) : (
